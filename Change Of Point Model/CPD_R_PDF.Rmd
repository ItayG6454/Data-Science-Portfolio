...
abstract: "So I was wondering whatever it is really getting hot in here or it's just me.
...
Those lines are the expected value of the post-prior distribution. Meaning, the left line in $\mu_1$ based on $y_{1:\tau}\sim f(\mu_1)$ , similarly - right line represent $\mu_2$ based on $y_{\tau:2015}\sim f(\mu_2)$:
![Screen shot of the interactive app from the HTML version]("./plots/intuiotion.png")
